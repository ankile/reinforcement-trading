...
class State1D(State):
    ...
    def encode(self):
        ...
        if self.volumes:
            ...
            res[3] = self._prices.volume[self._offset - ofs : self._offset + 1]
            res[4] = self._prices.vwap[self._offset - ofs : self._offset + 1]
            res[5] = self._prices.rsi[self._offset - ofs : self._offset + 1]
            res[6] = self._prices.bbands[self._offset - ofs : self._offset + 1]
            res[7] = self._prices.signal[self._offset - ofs : self._offset + 1]
            res[8] = self._prices.histogram[self._offset - ofs : self._offset + 1]
